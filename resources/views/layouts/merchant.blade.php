    ...
    <div id="wrapper">
        ...
        <div class="navbar-custom">
            ...
            <ul class="list-unstyled topnav-menu topnav-menu-left mb-0">
                ...
                <li>
                    <h4 class="page-title-main">Merchant Dashboard</h4>
                </li>
                    ...
                    <ul id="side-menu">
                        ...
                        <li>
                            <a href="{{ route('merchant') }}">
                                ...
                                <span class="badge bg-success rounded-pill float-end">s</span>
                                <span> Dashboard </span>
                            </a>
                        </li>
                        ...
                        {{-- platters --}}
                        <li>
                            <a href="#platters" data-bs-toggle="collapse">
                                <i class="mdi mdi-email-outline"></i>
                                <span> Platters </span>
                                <span class="menu-arrow"></span>
                            </a>
                        ...
                        {{-- party center --}}
                        <li>
                            <a href="#partycenter" data-bs-toggle="collapse">
                                <i class="mdi mdi-email-outline"></i>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            </script> &copy; Adminto theme by <a href="">Sabber</a>
                        </div>
                        <div class="col-md-6">
